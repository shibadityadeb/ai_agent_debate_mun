...
const DebateFeed = ({ messages, isLoading = false, isTyping = false, currentSpeaker = '', phase = 'idle' }) => {
  ...
  return (
    <GlassPanel className="flex h-full min-h-0 flex-col overflow-hidden p-5">
      ...
      <div className="relative mt-5 h-[500px] rounded-2xl bg-slate-900/50 p-3">
        <div className="flex h-full flex-col">
          <div className="flex-1 space-y-4 overflow-y-auto pr-2 scroll-smooth [scrollbar-color:rgba(148,163,184,0.45)_transparent] [scrollbar-width:thin]">
